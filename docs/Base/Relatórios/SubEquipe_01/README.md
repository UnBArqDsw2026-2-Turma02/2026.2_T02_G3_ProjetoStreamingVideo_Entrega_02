...
O relatório desta subequipe está dividido nos focos abaixo, cada um em seu próprio arquivo — assim cada frente (Estática, Dinâmica, IA Generativa) pode ser editada em paralelo sem gerar conflito com as demais.

- [FOCO_01: Modelagem Estática](1.ModelagemEstatica.md)
- [FOCO_02: Modelagem Dinâmica](2.ModelagemDinamica.md)
- [FOCO_03: IA Generativa](3.IAGenerativa.md)
- [Versionamentos](4.Versionamentos.md)
